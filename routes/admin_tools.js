...
module.exports = function registerAdminTools(app, ctx) {
    ...
    app.get('/api/admin/transport-config', requireAuth, (req, res) => {
        ...
        res.json({
            ...
            config: {
                ...
                hasTransportToken: Boolean(config.transportToken)
            }
        });
    });
    ...
    app.post('/api/admin/transport-config', requireAuth, (req, res) => {
        ...
        if (req.body.transportToken !== undefined && String(req.body.transportToken).trim()) {
            config.transportToken = String(req.body.transportToken).trim();
        }
